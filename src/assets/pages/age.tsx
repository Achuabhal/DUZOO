...
const EligibilityForm: React.FC = () => {
  ...
  return (
    <div style={{ margin: 0, padding: 0, minHeight: '100vh', backgroundColor: '#FFE4C4', display: 'flex', flexDirection: 'column', alignItems: 'center', fontFamily: 'Arial, sans-serif' }}>
      <div style={{ marginTop: '50px', width: '70px', height: '70px', backgroundColor: '#FF6347', borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '30px' }}>
        <div style={{ color: 'white', fontSize: '22px', fontWeight: 'bold' }}>DUZO</div>
      </div>
      <div style={{ background: 'white', width: '380px', borderRadius: '30px', padding: '25px', boxShadow: '0 2px 10px rgba(0,0,0,0.05)' }}>
        <h1 style={{ textAlign: 'center', margin: 0, paddingBottom: '15px', borderBottom: '1px solid #EEEEEE', fontSize: '18px', fontWeight: 'normal' }}>ELIGIBILITY</h1>
